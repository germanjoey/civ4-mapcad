...
#apply_shape_to_mask
    apply_shape_to_mask @maskname $groupname.layername [ --offsetX 0 --copy --offsetY 0 ] --shape_param1 value1 --shape_param2 value2 => $groupname.$layername 
...
#cutout_layer_with_mask
    cutout_layer_with_mask $groupname.layername @maskname [ --offsetY 0 --offsetX 0 --copy ] => $groupname.$layername 
...
#mask_difference
    mask_difference @maskname @maskname [ --offsetX 0 --offsetY 0 ] => @maskname 
      param 1: mask A
      param 2: mask B
